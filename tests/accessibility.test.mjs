...
test("every text colour on the battle screen clears WCAG AA", () => {
  ...
  const pairs = [
    ...
    [".battle-unit-card-name", "#0b1416"],
    [".battle-unit-stats", "#0b1416"],
    [".battle-unit-card-state", "#0b1416"],
    [".battle-unit-card-note", "#0b1416"],
    [".battle-mend", "#0e1e14"],
    [".battle-mend span", "#0e1e14"],
    [".battle-mend:disabled", "#0e1e14"],
    [".battle-enemy-brief li b", "#1c100d"],
    [".battle-enemy-brief li em", "#1c100d"],
    [".battle-enemy-brief li small", "#1c100d"],
    [".battle-enemy-read", "#1c100d"],
    [".battle-roads > span", "#181226"],
    [".battle-honours", "#0a1113"],
    [".battle-reserve > span", "#2a1a0c"],
    [".battle-reserve b", "#2a1a0c"],
    [".battle-reserve small", "#2a1a0c"],
    [".battle-spend-now", "#3a2410"],
    [".battle-road b", "#120e1c"],
    [".battle-road em", "#120e1c"],
    [".battle-road small", "#120e1c"],
    [".battle-road.taken b", "#2a1a0c"],
    [".battle-road.given-up b", "#120e1c"],
    [".battle-road.given-up em, .battle-road.given-up small", "#120e1c"],
    ...
    [".battle-note-row.found b", "#120e05"],
    [".battle-note-where", "#120e05"],
    [".battle-assignment-unpaid", "#0e181b"],
