...
export const PLAYBOOKS = [
  {
    ...
    roles: [
      { id: "pull", label: "LEAD ELEMENT", brief: "Seize the first control node and open the army route.", objective: "SEIZE", node: "alphaApproach", demands: ["CONTROL", "SHOCK"] },
      { id: "burn", label: "RELAY GUARD", brief: "Take responsibility for secured ground as the lead advances.", objective: "HOLD", node: "fireLine", demands: ["DENIAL", "COVER"] },
      { id: "break", label: "SABOTAGE ELEMENT", brief: "Pass through the opened route and disable the primary asset.", objective: "STRIKE", node: "breachLine", demands: ["BREACH", "CONTROL"] },
      { id: "anchor", label: "CORRIDOR SECURITY", brief: "Hold the route connecting the army to extraction.", objective: "HOLD", node: "anchorLine", demands: ["HOLD", "DENIAL"] },
      { id: "recover", label: "RECOVERY ELEMENT", brief: "Recover priority personnel and reform the army at extraction.", objective: "RECOVER", node: "recoveryLine", demands: ["RECOVERY", "SUPPORT"] },
    ],
  },
  {
    id: "spear",
    ...
    roles: [
      { id: "screen", label: "SCREENING ELEMENT", brief: "Protect the army while it concentrates for the assault.", objective: "SCREEN", node: "alphaApproach", demands: ["COVER", "SHOCK"] },
      { id: "point", label: "ADVANCE GUARD", brief: "Secure the narrow approach to the decisive objective.", objective: "SECURE", node: "highWalk", demands: ["MOBILITY", "SHOCK"] },
      { id: "punch", label: "ASSAULT ELEMENT", brief: "Break the objective defense and strike the primary asset.", objective: "STRIKE", node: "breachLine", demands: ["BREACH", "CONTROL"] },
      { id: "suppress", label: "FLANK SECURITY", brief: "Prevent enemy reinforcements from reaching the assault.", objective: "DENY", node: "fireLine", demands: ["DENIAL", "COVER"] },
      { id: "recover", label: "REAR ELEMENT", brief: "Recover the assault force through the secured corridor.", objective: "RECOVER", node: "recoveryLine", demands: ["RECOVERY", "SUPPORT"] },
    ],
  },
  {
    id: "pressure",
    ...
    roles: [
      { id: "alpha", label: "WEST OBJECTIVE GROUP", brief: "Seize and maintain the western control objective.", objective: "SEIZE", node: "alphaApproach", demands: ["HOLD", "CONTROL"] },
      { id: "beta", label: "EAST OBJECTIVE GROUP", brief: "Seize the eastern control objective in parallel.", objective: "SEIZE", node: "betaLane", demands: ["MOBILITY", "SHOCK"] },
      { id: "deny", label: "INTERDICTION ELEMENT", brief: "Prevent enemy movement between the two objective fights.", objective: "DENY", node: "fireLine", demands: ["DENIAL", "COVER"] },
      { id: "reactor", label: "CONVERGENCE ELEMENT", brief: "Unite both groups at the primary objective.", objective: "STRIKE", node: "breachLine", demands: ["BREACH", "CONTROL"] },
      { id: "recover", label: "EXTRACTION GUARD", brief: "Hold the extraction corridor, recover stragglers, and leave last.", objective: "RECOVER", node: "recoveryLine", demands: ["RECOVERY", "HOLD"] },
    ],
  },
];
