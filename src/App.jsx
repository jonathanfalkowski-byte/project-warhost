...
function TacticalFieldPlan({ assignments, branches, formations, phase, playbook }) {
...
export function App() {
  ...
  const drillSteps = useMemo(
    ...
    [assignedCount, condition, formations.length, operationProfile, playbook, tacticalHandoffs],
  );
